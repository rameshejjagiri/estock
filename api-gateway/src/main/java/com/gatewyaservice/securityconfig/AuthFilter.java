 ...
 * 
 * @Component public class AuthFilter extends
 * AbstractGatewayFilterFactory<AuthFilter.Config> {
 * 
 * private final WebClient.Builder webClientBuilder;
 * 
 * public AuthFilter(WebClient.Builder webClientBuilder) { super(Config.class);
 ...
 * System.err.println("Toekn Erro"); throw new
 * RuntimeException("Incorrect authorization structure"); }
 * 
 * return webClientBuilder.build().post().uri(
 * "http://MEMBER-SERVICE/member/validateToken?token=" + parts[1])
 ...
 * String.valueOf(userDto.getId())); return exchange; }).flatMap(chain::filter);
 * }; }
 * 
 * public static class Config { // empty class as I don't need any particular
 * configuration } }
 */